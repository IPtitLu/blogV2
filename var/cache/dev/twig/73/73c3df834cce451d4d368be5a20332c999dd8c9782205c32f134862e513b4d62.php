...
class __TwigTemplate_ea40762bd92c04b072793c5af35f2de11ad1ccf39bd20d378dd8e452da1472fe extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 20, $this->source); })()), "contenu", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Prix</th>
...
{% endblock %}
", "produit/show.html.twig", "/Users/lucasprz/Desktop/myproject/ptitlucommerce/templates/produit/show.html.twig");
    }
}
